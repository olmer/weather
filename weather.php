...
<script>
    ...
    $(function () {
        ...
        var getPreparedPics = function(a, b) {
            if ((a || a === 0) && b) {
                return $pics.slice(a, b).map(function(){$(this).attr('src', $(this).data('src'));return this;});
            } else {
        ...
        if (isMobile()) {
            ...
            $('span[data-load="first"]').on('click', function () {
                ...
                $('span[data-load="second"]').on('click', function () {
                    ...
                    $(this).remove();
                    $('.controls-container').remove();
                    $container = $('<div id="cycle_weather"></div>').append(getPreparedPics()).appendTo('body');
...
<script type="text/javascript">
    ...
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-43826183-1']);
